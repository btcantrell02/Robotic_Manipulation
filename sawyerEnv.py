...
class sawyerEnv(gym.Env):
	...
	def reward_s1(self):	
		...
		max_dist = 5
		min_rew = -0.1
		distance_reward = max(1 - (dist / max_dist), min_rew)
		position_reward = 0

		if x_rdy and y_rdy and z_rdy:
			position_reward += 1
		elif x_rdy and y_rdy or x_rdy and z_rdy or y_rdy and z_rdy:
			position_reward += 0.5
		elif x_rdy or y_rdy or z_rdy:
			position_reward += 0.25
		else:
			position_reward -= 0.1

		reward = distance_reward + position_reward
